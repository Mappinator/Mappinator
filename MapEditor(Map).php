    <div class="mapeditor" style="width:100%;height:100%">
		<canvas id="mapeditor" height="800" width="800" >
		</canvas>
		...
		<script lang="javascript">
			...
			var editor={
				...
				// redraw
				draw:function(){
				    context.clearRect(0,0,mapeditor.width,mapeditor.height);
		...
		<script lang="javascript">
			...
			var div=document.getElementByClassName("mapeditor")[0];
			...
			window.ondrop=function(event){
				...
				{
				    //[TEST]
				    //if (mapeditor.mode!="input") return;
			...
			canvas.width=mapeditor.width;
			canvas.height=mapeditor.height;	
		</script>
